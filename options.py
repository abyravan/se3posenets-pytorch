...
def setup_common_block_options():
    # Parse arguments
    parser = configargparse.ArgumentParser(description='SE3-Pose-Nets training on block stacking data')
    ...
    parser.add_argument('--se3-type', default='se3aa', type=str, metavar='SE3',
                        help='SE3 parameterization: [se3aa] | se3quat | se3spquat | se3euler | affine | se3aar')
    parser.add_argument('-n', '--num-se3', type=int, default=8,
                        help='Number of SE3s to predict (default: 8)')
    parser.add_argument('--init-transse3-iden', action='store_true', default=False,
                        help='Initialize the weights for the SE3 prediction layer of the transition model to predict identity')
    ...
    parser.add_argument('--sharpen-rate', default=1.0, type=float,
                        metavar='W', help='Slope of the weight sharpening (default: 1.0)')
    parser.add_argument('--noise-stop-iter', default=1e6, type=int, metavar='N',
                        help='Stop noise addition during weight sharpening from this training iteration(default: 1e6)')
