...
ext_modules = [
    Extension(
        "torchviz.pangoviz",                                # the extension name
        sources=['torchviz/pangoviz.pyx'],
        language='c++',
        extra_objects=[curr_path + "/torchviz/build/libpangoviz.so"],
    ...
    Extension(
        "torchviz.pangoposeviz",                                # the extension name
        sources=['torchviz/pangoposeviz.pyx'],
        language='c++',
        extra_objects=[curr_path + "/torchviz/build/libpangoposeviz.so"],
        extra_compile_args={'gcc': ["-Wno-unused-function", "-D_GLIBCXX_USE_CXX11_ABI=0"],
                            'nvcc': ['-arch=sm_35',
                                     '--ptxas-options=-v',
                                     '-c',
    ...
    Extension(
        "torchviz.pangodataviz",                                # the extension name
        sources=['torchviz/pangodataviz.pyx'],
        language='c++',
        extra_objects=[curr_path + "/torchviz/build/libpangodataviz.so"],
        extra_compile_args={'gcc': ["-Wno-unused-function", "-D_GLIBCXX_USE_CXX11_ABI=0"],
                            'nvcc': ['-arch=sm_35',
                                     '--ptxas-options=-v',
                                     '-c',
    ...
    Extension(
        ...
        language='c++',
        extra_objects=[curr_path + "/torchviz/build/librealctrlcompviz.so"],
        extra_compile_args={'gcc': ["-Wno-unused-function", "-D_GLIBCXX_USE_CXX11_ABI=0"],
                            'nvcc': ['-arch=sm_35',
                                     '--ptxas-options=-v',
                                     '-c',
