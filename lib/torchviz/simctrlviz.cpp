...
#define __PYX_HAVE__torchviz__simctrlviz
#define __PYX_HAVE_API__torchviz__simctrlviz
#include <string.h>
#include <string>
#include "ios"
#include "new"
...
/*--- Type declarations ---*/
struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz;
...
/* Module declarations from 'torchviz.simctrlviz' */
static PyTypeObject *__pyx_ptype_8torchviz_10simctrlviz_PySimCtrlViz = 0;
static std::string __pyx_convert_string_from_py_std__in_string(PyObject *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "torchviz.simctrlviz"
int __pyx_module_is_main_torchviz__simctrlviz = 0;

/* Implementation of 'torchviz.simctrlviz' */
...
static const char __pyx_k_config1[] = "config1";
static const char __pyx_k_config2[] = "config2";
...
static const char __pyx_k_posenets[] = "posenets";
...
static const char __pyx_k_torchviz_simctrlviz[] = "torchviz.simctrlviz";
...
static const char __pyx_k_home_barun_Projects_se3nets_pyt[] = "/home/barun/Projects/se3nets-pytorch/lib/torchviz/simctrlviz.pyx";
...
static PyObject *__pyx_n_s_config1;
...
static PyObject *__pyx_n_s_init_deg_error;
static PyObject *__pyx_n_s_init_pose_error;
static PyObject *__pyx_n_s_init_pose_error_indiv;
...
static PyObject *__pyx_n_s_posenets;
...
static PyObject *__pyx_n_s_torchviz_simctrlviz;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_winsize;
static PyObject *__pyx_pf_8torchviz_10simctrlviz_assert_contiguous(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_arrays); /* proto */
static int __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz___cinit__(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, int __pyx_v_img_ht, int __pyx_v_img_wd, float __pyx_v_img_scale, int __pyx_v_num_se3, float __pyx_v_fx, float __pyx_v_fy, float __pyx_v_cx, float __pyx_v_cy, std::string __pyx_v_savedir, int __pyx_v_posenets); /* proto */
static void __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_2__dealloc__(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_4render_arm(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config, PyArrayObject *__pyx_v_ptcloud, PyArrayObject *__pyx_v_labels); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_6compute_gt_da(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config1, PyArrayObject *__pyx_v_config2, int __pyx_v_winsize, float __pyx_v_thresh, PyArrayObject *__pyx_v_gtwarped_out, PyArrayObject *__pyx_v_gtda_ids); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_8initialize_problem(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config1, PyArrayObject *__pyx_v_config2, PyArrayObject *__pyx_v_start_pts, PyArrayObject *__pyx_v_da_goal_pts); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_10update_curr(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_curr_angles, PyArrayObject *__pyx_v_curr_ptcloud, PyArrayObject *__pyx_v_curr_poses, PyArrayObject *__pyx_v_curr_masks, float __pyx_v_curr_pose_error, PyArrayObject *__pyx_v_curr_pose_error_indiv, PyArrayObject *__pyx_v_curr_deg_error, int __pyx_v_save_frame); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_12update_init(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_start_angles, PyArrayObject *__pyx_v_start_ptcloud, PyArrayObject *__pyx_v_start_poses, PyArrayObject *__pyx_v_start_masks, PyArrayObject *__pyx_v_goal_angles, PyArrayObject *__pyx_v_goal_ptcloud, PyArrayObject *__pyx_v_goal_poses, PyArrayObject *__pyx_v_goal_masks, float __pyx_v_init_pose_error, PyArrayObject *__pyx_v_init_pose_error_indiv, PyArrayObject *__pyx_v_init_deg_error); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_14reset(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_16start_saving_frames(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, std::string __pyx_v_framesavedir); /* proto */
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_18stop_saving_frames(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_8torchviz_10simctrlviz_PySimCtrlViz(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_1assert_contiguous(PyObject *__pyx_self, PyObject *__pyx_v_arrays); /*proto*/
static PyMethodDef __pyx_mdef_8torchviz_10simctrlviz_1assert_contiguous = {"assert_contiguous", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_1assert_contiguous, METH_O, 0};
static PyObject *__pyx_pw_8torchviz_10simctrlviz_1assert_contiguous(PyObject *__pyx_self, PyObject *__pyx_v_arrays) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("assert_contiguous (wrapper)", 0);
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_assert_contiguous(__pyx_self, ((PyObject *)__pyx_v_arrays));
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_assert_contiguous(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_arrays) {
 ...
 */
  ...
  __Pyx_AddTraceback("torchviz.simctrlviz.assert_contiguous", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* Python wrapper */
static int __pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_img_ht;
  int __pyx_v_img_wd;
  ...
  int __pyx_v_posenets;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img_ht,&__pyx_n_s_img_wd,&__pyx_n_s_img_scale,&__pyx_n_s_num_se3,&__pyx_n_s_fx,&__pyx_n_s_fy,&__pyx_n_s_cx,&__pyx_n_s_cy,&__pyx_n_s_savedir,&__pyx_n_s_posenets,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_posenets)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_posenets = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_posenets == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 10, 10, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 59, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz___cinit__(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_img_ht, __pyx_v_img_wd, __pyx_v_img_scale, __pyx_v_num_se3, __pyx_v_fx, __pyx_v_fy, __pyx_v_cx, __pyx_v_cy, __pyx_v_savedir, __pyx_v_posenets);
...
static int __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz___cinit__(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, int __pyx_v_img_ht, int __pyx_v_img_wd, float __pyx_v_img_scale, int __pyx_v_num_se3, float __pyx_v_fx, float __pyx_v_fy, float __pyx_v_cx, float __pyx_v_cy, std::string __pyx_v_savedir, int __pyx_v_posenets) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__", 0);

  /* "torchviz/simctrlviz.pyx":62
 *                     float fx, float fy, float cx, float cy,
 *                     string savedir, int posenets):
 *         self.img_ht   = img_ht             # <<<<<<<<<<<<<<
 *         self.img_wd   = img_wd
 ...
 * 
 */
  __pyx_v_self->simctrlviz = new SimCtrlViz(__pyx_v_img_ht, __pyx_v_img_wd, __pyx_v_img_scale, __pyx_v_num_se3, __pyx_v_fx, __pyx_v_fy, __pyx_v_cx, __pyx_v_cy, __pyx_v_savedir, __pyx_v_posenets);
...
/* Python wrapper */
static void __pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_2__dealloc__(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_2__dealloc__(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__", 0);

  /* "torchviz/simctrlviz.pyx":68
 * 
 *     def __dealloc__(self):
 *         del self.simctrlviz             # <<<<<<<<<<<<<<
 * 
 ...
 */
  delete __pyx_v_self->simctrlviz;
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_5render_arm(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_5render_arm(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_config,&__pyx_n_s_ptcloud,&__pyx_n_s_labels,0};
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.render_arm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_4render_arm(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_config, __pyx_v_ptcloud, __pyx_v_labels);
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_4render_arm(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config, PyArrayObject *__pyx_v_ptcloud, PyArrayObject *__pyx_v_labels) {
 ...
 */
  ...
  } else if (unlikely(__pyx_t_6 >= __pyx_pybuffernd_labels.diminfo[0].shape)) __pyx_t_2 = 0;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_pybuffernd_labels.diminfo[1].shape;
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_labels.diminfo[1].shape)) __pyx_t_2 = 1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_pybuffernd_labels.diminfo[2].shape;
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_7compute_gt_da(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_7compute_gt_da(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_config1,&__pyx_n_s_config2,&__pyx_n_s_winsize,&__pyx_n_s_thresh,&__pyx_n_s_gtwarped_out,&__pyx_n_s_gtda_ids,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_config1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.compute_gt_da", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_6compute_gt_da(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_config1, __pyx_v_config2, __pyx_v_winsize, __pyx_v_thresh, __pyx_v_gtwarped_out, __pyx_v_gtda_ids);
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_6compute_gt_da(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config1, PyArrayObject *__pyx_v_config2, int __pyx_v_winsize, float __pyx_v_thresh, PyArrayObject *__pyx_v_gtwarped_out, PyArrayObject *__pyx_v_gtda_ids) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_config1;
  __Pyx_Buffer __pyx_pybuffer_config1;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_config2;
  __Pyx_Buffer __pyx_pybuffer_config2;
  ...
  __pyx_pybuffer_config1.pybuffer.buf = NULL;
  __pyx_pybuffer_config1.refcount = 0;
  __pyx_pybuffernd_config1.data = NULL;
  __pyx_pybuffernd_config1.rcbuffer = &__pyx_pybuffer_config1;
  __pyx_pybuffer_config2.pybuffer.buf = NULL;
  __pyx_pybuffer_config2.refcount = 0;
  __pyx_pybuffernd_config2.data = NULL;
  __pyx_pybuffernd_config2.rcbuffer = &__pyx_pybuffer_config2;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_pybuffernd_config1.diminfo[0].shape;
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_config2.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_gtwarped_out.diminfo[0].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_gtwarped_out.diminfo[0].shape)) __pyx_t_2 = 0;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_pybuffernd_gtwarped_out.diminfo[1].shape;
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_5 >= __pyx_pybuffernd_gtwarped_out.diminfo[1].shape)) __pyx_t_2 = 1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_pybuffernd_gtwarped_out.diminfo[2].shape;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_pybuffernd_gtda_ids.diminfo[0].shape;
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_gtda_ids.diminfo[0].shape)) __pyx_t_2 = 0;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_pybuffernd_gtda_ids.diminfo[1].shape;
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_gtda_ids.diminfo[1].shape)) __pyx_t_2 = 1;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_pybuffernd_gtda_ids.diminfo[2].shape;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_PyThreadState_assign
    __Pyx_ErrFetch(&__pyx_type, &__pyx_value, &__pyx_tb);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_config1.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_config2.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_9initialize_problem(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_9initialize_problem(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_config1 = 0;
  PyArrayObject *__pyx_v_config2 = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("initialize_problem (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_config1,&__pyx_n_s_config2,&__pyx_n_s_start_pts,&__pyx_n_s_da_goal_pts,0};
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.initialize_problem", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_8initialize_problem(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_config1, __pyx_v_config2, __pyx_v_start_pts, __pyx_v_da_goal_pts);
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_8initialize_problem(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_config1, PyArrayObject *__pyx_v_config2, PyArrayObject *__pyx_v_start_pts, PyArrayObject *__pyx_v_da_goal_pts) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_config1;
  __Pyx_Buffer __pyx_pybuffer_config1;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_config2;
  __Pyx_Buffer __pyx_pybuffer_config2;
  ...
  Py_ssize_t __pyx_t_8;
  Py_ssize_t __pyx_t_9;
  __Pyx_RefNannySetupContext("initialize_problem", 0);
  __pyx_pybuffer_config1.pybuffer.buf = NULL;
  __pyx_pybuffer_config1.refcount = 0;
  __pyx_pybuffernd_config1.data = NULL;
  __pyx_pybuffernd_config1.rcbuffer = &__pyx_pybuffer_config1;
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_11update_curr(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_11update_curr(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("update_curr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_curr_angles,&__pyx_n_s_curr_ptcloud,&__pyx_n_s_curr_poses,&__pyx_n_s_curr_masks,&__pyx_n_s_curr_pose_error,&__pyx_n_s_curr_pose_error_indiv,&__pyx_n_s_curr_deg_error,&__pyx_n_s_save_frame,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_ptcloud)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 1); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_poses)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 2); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_masks)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 3); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_pose_error)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 4); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_pose_error_indiv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 5); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_deg_error)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 6); __PYX_ERR(0, 101, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_save_frame)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, 7); __PYX_ERR(0, 101, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "update_curr") < 0)) __PYX_ERR(0, 101, __pyx_L3_error)
      }
    ...
    __pyx_v_curr_pose_error = __pyx_PyFloat_AsFloat(values[4]); if (unlikely((__pyx_v_curr_pose_error == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_curr_pose_error_indiv = ((PyArrayObject *)values[5]);
    __pyx_v_curr_deg_error = ((PyArrayObject *)values[6]);
    __pyx_v_save_frame = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_save_frame == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 108, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("update_curr", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 101, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.update_curr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_curr_pose_error_indiv), __pyx_ptype_5numpy_ndarray, 1, "curr_pose_error_indiv", 0))) __PYX_ERR(0, 106, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_curr_deg_error), __pyx_ptype_5numpy_ndarray, 1, "curr_deg_error", 0))) __PYX_ERR(0, 107, __pyx_L1_error)
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_10update_curr(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_curr_angles, __pyx_v_curr_ptcloud, __pyx_v_curr_poses, __pyx_v_curr_masks, __pyx_v_curr_pose_error, __pyx_v_curr_pose_error_indiv, __pyx_v_curr_deg_error, __pyx_v_save_frame);
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_10update_curr(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_curr_angles, PyArrayObject *__pyx_v_curr_ptcloud, PyArrayObject *__pyx_v_curr_poses, PyArrayObject *__pyx_v_curr_masks, float __pyx_v_curr_pose_error, PyArrayObject *__pyx_v_curr_pose_error_indiv, PyArrayObject *__pyx_v_curr_deg_error, int __pyx_v_save_frame) {
  ...
  __Pyx_RefNannySetupContext("update_curr", 0);
  ...
  __pyx_pybuffer_curr_pose_error_indiv.pybuffer.buf = NULL;
  __pyx_pybuffer_curr_pose_error_indiv.refcount = 0;
  __pyx_pybuffernd_curr_pose_error_indiv.data = NULL;
  __pyx_pybuffernd_curr_pose_error_indiv.rcbuffer = &__pyx_pybuffer_curr_pose_error_indiv;
  __pyx_pybuffer_curr_deg_error.pybuffer.buf = NULL;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_12 < 0) {
    __pyx_t_12 += __pyx_pybuffernd_curr_pose_error_indiv.diminfo[0].shape;
    if (unlikely(__pyx_t_12 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_curr_pose_error_indiv.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 115, __pyx_L1_error)
  }

  /* "torchviz/simctrlviz.pyx":116
 *                                        curr_pose_error,
 *                                        &curr_pose_error_indiv[0],
 *                                        &curr_deg_error[0],             # <<<<<<<<<<<<<<
 *                                        save_frame)
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_13 < 0) {
    __pyx_t_13 += __pyx_pybuffernd_curr_deg_error.diminfo[0].shape;
    if (unlikely(__pyx_t_13 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_curr_deg_error.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_13update_init(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_13update_init(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  float __pyx_v_init_pose_error;
  PyArrayObject *__pyx_v_init_pose_error_indiv = 0;
  PyArrayObject *__pyx_v_init_deg_error = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("update_init (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_start_angles,&__pyx_n_s_start_ptcloud,&__pyx_n_s_start_poses,&__pyx_n_s_start_masks,&__pyx_n_s_goal_angles,&__pyx_n_s_goal_ptcloud,&__pyx_n_s_goal_poses,&__pyx_n_s_goal_masks,&__pyx_n_s_init_pose_error,&__pyx_n_s_init_pose_error_indiv,&__pyx_n_s_init_deg_error,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start_ptcloud)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 1); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start_poses)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 2); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start_masks)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 3); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_goal_angles)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 4); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_goal_ptcloud)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 5); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_goal_poses)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 6); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_goal_masks)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 7); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_init_pose_error)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 8); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_init_pose_error_indiv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 9); __PYX_ERR(0, 119, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_init_deg_error)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, 10); __PYX_ERR(0, 119, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "update_init") < 0)) __PYX_ERR(0, 119, __pyx_L3_error)
      }
    ...
    __pyx_v_init_pose_error = __pyx_PyFloat_AsFloat(values[8]); if (unlikely((__pyx_v_init_pose_error == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L3_error)
    __pyx_v_init_pose_error_indiv = ((PyArrayObject *)values[9]);
    __pyx_v_init_deg_error = ((PyArrayObject *)values[10]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("update_init", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 119, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.update_init", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_start_angles), __pyx_ptype_5numpy_ndarray, 1, "start_angles", 0))) __PYX_ERR(0, 119, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_start_ptcloud), __pyx_ptype_5numpy_ndarray, 1, "start_ptcloud", 0))) __PYX_ERR(0, 120, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_start_poses), __pyx_ptype_5numpy_ndarray, 1, "start_poses", 0))) __PYX_ERR(0, 121, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_start_masks), __pyx_ptype_5numpy_ndarray, 1, "start_masks", 0))) __PYX_ERR(0, 122, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_goal_angles), __pyx_ptype_5numpy_ndarray, 1, "goal_angles", 0))) __PYX_ERR(0, 123, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_goal_ptcloud), __pyx_ptype_5numpy_ndarray, 1, "goal_ptcloud", 0))) __PYX_ERR(0, 124, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_goal_poses), __pyx_ptype_5numpy_ndarray, 1, "goal_poses", 0))) __PYX_ERR(0, 125, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_goal_masks), __pyx_ptype_5numpy_ndarray, 1, "goal_masks", 0))) __PYX_ERR(0, 126, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_init_pose_error_indiv), __pyx_ptype_5numpy_ndarray, 1, "init_pose_error_indiv", 0))) __PYX_ERR(0, 128, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_init_deg_error), __pyx_ptype_5numpy_ndarray, 1, "init_deg_error", 0))) __PYX_ERR(0, 129, __pyx_L1_error)
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_12update_init(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), __pyx_v_start_angles, __pyx_v_start_ptcloud, __pyx_v_start_poses, __pyx_v_start_masks, __pyx_v_goal_angles, __pyx_v_goal_ptcloud, __pyx_v_goal_poses, __pyx_v_goal_masks, __pyx_v_init_pose_error, __pyx_v_init_pose_error_indiv, __pyx_v_init_deg_error);
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_12update_init(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, PyArrayObject *__pyx_v_start_angles, PyArrayObject *__pyx_v_start_ptcloud, PyArrayObject *__pyx_v_start_poses, PyArrayObject *__pyx_v_start_masks, PyArrayObject *__pyx_v_goal_angles, PyArrayObject *__pyx_v_goal_ptcloud, PyArrayObject *__pyx_v_goal_poses, PyArrayObject *__pyx_v_goal_masks, float __pyx_v_init_pose_error, PyArrayObject *__pyx_v_init_pose_error_indiv, PyArrayObject *__pyx_v_init_deg_error) {
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_init_deg_error;
  __Pyx_Buffer __pyx_pybuffer_init_deg_error;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_init_pose_error_indiv;
  __Pyx_Buffer __pyx_pybuffer_init_pose_error_indiv;
  ...
  __Pyx_RefNannySetupContext("update_init", 0);
  ...
  __pyx_pybuffer_init_pose_error_indiv.pybuffer.buf = NULL;
  __pyx_pybuffer_init_pose_error_indiv.refcount = 0;
  __pyx_pybuffernd_init_pose_error_indiv.data = NULL;
  __pyx_pybuffernd_init_pose_error_indiv.rcbuffer = &__pyx_pybuffer_init_pose_error_indiv;
  __pyx_pybuffer_init_deg_error.pybuffer.buf = NULL;
  __pyx_pybuffer_init_deg_error.refcount = 0;
  __pyx_pybuffernd_init_deg_error.data = NULL;
  __pyx_pybuffernd_init_deg_error.rcbuffer = &__pyx_pybuffer_init_deg_error;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_start_angles.rcbuffer->pybuffer, (PyObject*)__pyx_v_start_angles, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_start_ptcloud.rcbuffer->pybuffer, (PyObject*)__pyx_v_start_ptcloud, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_start_poses.rcbuffer->pybuffer, (PyObject*)__pyx_v_start_poses, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_start_masks.rcbuffer->pybuffer, (PyObject*)__pyx_v_start_masks, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_goal_angles.rcbuffer->pybuffer, (PyObject*)__pyx_v_goal_angles, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_goal_ptcloud.rcbuffer->pybuffer, (PyObject*)__pyx_v_goal_ptcloud, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_goal_poses.rcbuffer->pybuffer, (PyObject*)__pyx_v_goal_poses, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_goal_masks.rcbuffer->pybuffer, (PyObject*)__pyx_v_goal_masks, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_init_pose_error_indiv.rcbuffer->pybuffer, (PyObject*)__pyx_v_init_pose_error_indiv, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_init_deg_error.rcbuffer->pybuffer, (PyObject*)__pyx_v_init_deg_error, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 119, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_22 < 0) {
    __pyx_t_22 += __pyx_pybuffernd_init_pose_error_indiv.diminfo[0].shape;
    if (unlikely(__pyx_t_22 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_init_pose_error_indiv.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 140, __pyx_L1_error)
  }

  /* "torchviz/simctrlviz.pyx":141
 *                                        init_pose_error,
 *                                        &init_pose_error_indiv[0],
 *                                        &init_deg_error[0])             # <<<<<<<<<<<<<<
 *     def reset(self):
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_23 < 0) {
    __pyx_t_23 += __pyx_pybuffernd_init_deg_error.diminfo[0].shape;
    if (unlikely(__pyx_t_23 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_init_deg_error.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 *                                        &start_poses[0,0,0],
 */
  __pyx_v_self->simctrlviz->update_init((&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_start_angles.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_start_angles.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_start_ptcloud.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_start_ptcloud.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_start_ptcloud.diminfo[1].strides, __pyx_t_5, __pyx_pybuffernd_start_ptcloud.diminfo[2].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_start_poses.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_start_poses.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_start_poses.diminfo[1].strides, __pyx_t_8, __pyx_pybuffernd_start_poses.diminfo[2].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_start_masks.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_start_masks.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_start_masks.diminfo[1].strides, __pyx_t_11, __pyx_pybuffernd_start_masks.diminfo[2].strides))), (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_goal_angles.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_goal_angles.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_goal_ptcloud.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_goal_ptcloud.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_goal_ptcloud.diminfo[1].strides, __pyx_t_15, __pyx_pybuffernd_goal_ptcloud.diminfo[2].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_goal_poses.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_goal_poses.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_goal_poses.diminfo[1].strides, __pyx_t_18, __pyx_pybuffernd_goal_poses.diminfo[2].strides))), (&(*__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_goal_masks.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_goal_masks.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_goal_masks.diminfo[1].strides, __pyx_t_21, __pyx_pybuffernd_goal_masks.diminfo[2].strides))), __pyx_v_init_pose_error, (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_init_pose_error_indiv.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_init_pose_error_indiv.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_init_deg_error.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_init_deg_error.diminfo[0].strides))));
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_init_deg_error.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_init_pose_error_indiv.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_15reset(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_15reset(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("reset (wrapper)", 0);
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_14reset(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self));
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_14reset(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("reset", 0);

  /* "torchviz/simctrlviz.pyx":144
 *     def reset(self):
 *         # Run CPP code
 *         self.simctrlviz.reset()             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_17start_saving_frames(PyObject *__pyx_v_self, PyObject *__pyx_arg_framesavedir); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_17start_saving_frames(PyObject *__pyx_v_self, PyObject *__pyx_arg_framesavedir) {
  std::string __pyx_v_framesavedir;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start_saving_frames (wrapper)", 0);
  assert(__pyx_arg_framesavedir); {
    __pyx_v_framesavedir = __pyx_convert_string_from_py_std__in_string(__pyx_arg_framesavedir); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 146, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("torchviz.simctrlviz.PySimCtrlViz.start_saving_frames", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_16start_saving_frames(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self), ((std::string)__pyx_v_framesavedir));
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_16start_saving_frames(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self, std::string __pyx_v_framesavedir) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start_saving_frames", 0);

  /* "torchviz/simctrlviz.pyx":148
 *     def start_saving_frames(self, string framesavedir):
 *         # Run CPP code
 *         self.simctrlviz.start_saving_frames(framesavedir)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_self->simctrlviz->start_saving_frames(__pyx_v_framesavedir);
...
/* Python wrapper */
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_19stop_saving_frames(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_19stop_saving_frames(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("stop_saving_frames (wrapper)", 0);
  __pyx_r = __pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_18stop_saving_frames(((struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *)__pyx_v_self));
...
static PyObject *__pyx_pf_8torchviz_10simctrlviz_12PySimCtrlViz_18stop_saving_frames(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("stop_saving_frames", 0);

  /* "torchviz/simctrlviz.pyx":152
 *     def stop_saving_frames(self):
 *         # Run CPP code
 *         self.simctrlviz.stop_saving_frames()             # <<<<<<<<<<<<<<
 */
  __pyx_v_self->simctrlviz->stop_saving_frames();
...
static PyObject *__pyx_tp_new_8torchviz_10simctrlviz_PySimCtrlViz(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_8torchviz_10simctrlviz_PySimCtrlViz(PyObject *o) {
  ...
  #endif
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_3__dealloc__(o);
    --Py_REFCNT(o);
...
static PyMethodDef __pyx_methods_8torchviz_10simctrlviz_PySimCtrlViz[] = {
  {"render_arm", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_5render_arm, METH_VARARGS|METH_KEYWORDS, 0},
  {"compute_gt_da", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_7compute_gt_da, METH_VARARGS|METH_KEYWORDS, 0},
  {"initialize_problem", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_9initialize_problem, METH_VARARGS|METH_KEYWORDS, 0},
  {"update_curr", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_11update_curr, METH_VARARGS|METH_KEYWORDS, 0},
  {"update_init", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_13update_init, METH_VARARGS|METH_KEYWORDS, 0},
  {"reset", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_15reset, METH_NOARGS, 0},
  {"start_saving_frames", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_17start_saving_frames, METH_O, 0},
  {"stop_saving_frames", (PyCFunction)__pyx_pw_8torchviz_10simctrlviz_12PySimCtrlViz_19stop_saving_frames, METH_NOARGS, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_8torchviz_10simctrlviz_PySimCtrlViz = {
  PyVarObject_HEAD_INIT(0, 0)
  "torchviz.simctrlviz.PySimCtrlViz", /*tp_name*/
  sizeof(struct __pyx_obj_8torchviz_10simctrlviz_PySimCtrlViz), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_8torchviz_10simctrlviz_PySimCtrlViz, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_8torchviz_10simctrlviz_PySimCtrlViz, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_8torchviz_10simctrlviz_PySimCtrlViz, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_config1, __pyx_k_config1, sizeof(__pyx_k_config1), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_init_deg_error, __pyx_k_init_deg_error, sizeof(__pyx_k_init_deg_error), 0, 0, 1, 1},
  {&__pyx_n_s_init_pose_error, __pyx_k_init_pose_error, sizeof(__pyx_k_init_pose_error), 0, 0, 1, 1},
  {&__pyx_n_s_init_pose_error_indiv, __pyx_k_init_pose_error_indiv, sizeof(__pyx_k_init_pose_error_indiv), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_posenets, __pyx_k_posenets, sizeof(__pyx_k_posenets), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_torchviz_simctrlviz, __pyx_k_torchviz_simctrlviz, sizeof(__pyx_k_torchviz_simctrlviz), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsimctrlviz(void); /*proto*/
PyMODINIT_FUNC initsimctrlviz(void)
#else
PyMODINIT_FUNC PyInit_simctrlviz(void); /*proto*/
PyMODINIT_FUNC PyInit_simctrlviz(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_simctrlviz(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("simctrlviz", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_torchviz__simctrlviz) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "torchviz.simctrlviz")) {
      if (unlikely(PyDict_SetItemString(modules, "torchviz.simctrlviz", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_8torchviz_10simctrlviz_PySimCtrlViz) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_type_8torchviz_10simctrlviz_PySimCtrlViz.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "PySimCtrlViz", (PyObject *)&__pyx_type_8torchviz_10simctrlviz_PySimCtrlViz) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_ptype_8torchviz_10simctrlviz_PySimCtrlViz = &__pyx_type_8torchviz_10simctrlviz_PySimCtrlViz;
  /*--- Type import code ---*/
 ...
 *         assert arr.flags['C_CONTIGUOUS']
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8torchviz_10simctrlviz_1assert_contiguous, NULL, __pyx_n_s_torchviz_simctrlviz); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_assert_contiguous, __pyx_t_1) < 0) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "torchviz/simctrlviz.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # SE3-POSE-NETS
 * # Copyright (c) 2017
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init torchviz.simctrlviz", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init torchviz.simctrlviz");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
