...
public:
    ...
    void setGeometryScale(const int geomNumber, const float3 scale) {
        _geomScales[geomNumber].x = scale.x;
        _geomScales[geomNumber].y = scale.y;
        _geomScales[geomNumber].z = scale.z;
    } // Added by Arun
