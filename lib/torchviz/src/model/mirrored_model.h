...
public:
    ...
    inline bool getCameraToModelOptimizeFlag() { return _optimize_T_cm; }
    inline void setCameraToModelOptimizeFlag(const bool flag) { _optimize_T_cm = flag; }
private:
    ...
    // boolean for updating model to camera transform
    bool _optimize_T_cm;
